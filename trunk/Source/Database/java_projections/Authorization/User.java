...
public class User extends com.intersys.classes.Persistent {
   ...
   */
    ...
    */
    ...
    private static int ii_Password = 7;
    private static int jj_Password = 0;
    private static int kk_Password = 7;
    /**
    ...
    */
    ...
    private static int ii_Roles = 4;
    private static int jj_Roles = 0;
    private static int kk_Roles = 4;
    /**
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Authorization.User#PersonGetObject"> Method PersonGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Authorization.User#PersonGetObjectId"> Method PersonGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Authorization.User#PersonIndexExists"> Method PersonIndexExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Authorization.User#PersonSetObject"> Method PersonSetObject</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Authorization.User#PersonSetObjectId"> Method PersonSetObjectId</A>
    */
