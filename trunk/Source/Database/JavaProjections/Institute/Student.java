...
public class Student extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 3466;
   ...
   */
    ...
    private static int ii_AcceptanceDate = 1;
    private static int jj_AcceptanceDate = 0;
    private static int kk_AcceptanceDate = 1;
    /**
    ...
    */
    ...
    private static int ii_DeductionDate = 5;
    private static int jj_DeductionDate = 0;
    private static int kk_DeductionDate = 5;
    /**
    ...
    */
    ...
    private static int ii_Number = 6;
    private static int jj_Number = 0;
    private static int kk_Number = 6;
    /**
    ...
    */
    ...
    private static int ii_TestBook = 2;
    private static int jj_TestBook = 0;
    private static int kk_TestBook = 2;
    /**
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Student#PersonDisplayToLogical"> Method PersonDisplayToLogical</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Student#PersonLogicalToDisplay"> Method PersonLogicalToDisplay</A>
    */
...
<LINK href=DocBook.UI.Page.cls?KEY=GOBJ_populate>The Cach&eacute; Populate Utility</LINK>.</p>
    ...
    */
    ...
    public static Object addToBatchInsert (Object batch, java.sql.Connection con, java.sql.Date cos_AcceptanceDate, java.sql.Date cos_DeductionDate, String cos_Number, Integer cos_Person, String cos_TestBook) throws java.sql.SQLException {
        if (batch == null) {
