...
public class Employee extends com.intersys.classes.Persistent {
   ...
   */
    ...
    */
    ...
    private static int ii_Card = 1;
    private static int jj_Card = 0;
    private static int kk_Card = 1;
    /**
    ...
    */
    ...
    private static int ii_Insurance = 8;
    private static int jj_Insurance = 0;
    private static int kk_Insurance = 8;
    /**
    ...
    */
    ...
    private static int ii_Person = 9;
    private static int jj_Person = 0;
    private static int kk_Person = 9;
    /**
    ...
    */
    public java.lang.Integer getPerson()  throws com.intersys.objects.CacheException {
    ...
    /**
       ...
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Employee#Person"> Person</A>
    */
    public void setPerson(java.lang.Integer value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty(ii_Person, jj_Person,kk_Person, com.intersys.objects.Database.RET_PRIM, "Person", dh);
        return;
    }

    private static int ii_Postal = 4;
    private static int jj_Postal = 0;
    private static int kk_Postal = 4;
    /**
    ...
    */
    ...
    private static int ii_Receipt = 5;
    private static int jj_Receipt = 0;
    private static int kk_Receipt = 5;
    /**
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     <p>Runs method PersonDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Employee#PersonDisplayToLogical"> Method PersonDisplayToLogical</A>
    */
    public static java.lang.Integer PersonDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PersonDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getInteger();
    }
    /**
    ...
    */
    public static void PersonIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
    ...
    /**
     <p>Runs method PersonLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.Integer
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Employee#PersonLogicalToDisplay"> Method PersonLogicalToDisplay</A>
    */
    public static java.lang.String PersonLogicalToDisplay (com.intersys.objects.Database db, java.lang.Integer _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PersonLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
