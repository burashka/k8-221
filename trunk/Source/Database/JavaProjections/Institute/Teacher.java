...
public class Teacher extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 5636;
   ...
   */
    ...
    */
    ...
    private static int ii_Employee = 3;
    private static int jj_Employee = 0;
    private static int kk_Employee = 3;
    /**
    ...
    */
    public java.lang.Integer getEmployee()  throws com.intersys.objects.CacheException {
    ...
    /**
       ...
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Teacher#Employee"> Employee</A>
    */
    public void setEmployee(java.lang.Integer value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty(ii_Employee, jj_Employee,kk_Employee, com.intersys.objects.Database.RET_PRIM, "Employee", dh);
        return;
    }
    ...
    */
    ...
    private static int ii_Speciality = 9;
    private static int jj_Speciality = 0;
    private static int kk_Speciality = 9;
    /**
    ...
    */
    ...
    private static int ii_Subjects = 4;
    private static int jj_Subjects = 0;
    private static int kk_Subjects = 4;
    /**
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Teacher#ChairDisplayToLogical"> Method ChairDisplayToLogical</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Teacher#ChairLogicalToDisplay"> Method ChairLogicalToDisplay</A>
    */
    ...
    */
    ...
    /**
     <p>Runs method EmployeeDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Teacher#EmployeeDisplayToLogical"> Method EmployeeDisplayToLogical</A>
    */
    public static java.lang.Integer EmployeeDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"EmployeeDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getInteger();
    }
    /**
    ...
    */
    public static void EmployeeIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
    ...
    /**
     <p>Runs method EmployeeLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.Integer
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Teacher#EmployeeLogicalToDisplay"> Method EmployeeLogicalToDisplay</A>
    */
    public static java.lang.String EmployeeLogicalToDisplay (com.intersys.objects.Database db, java.lang.Integer _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"EmployeeLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Teacher#FacultyDisplayToLogical"> Method FacultyDisplayToLogical</A>
    */
    ...
    */
    ...
    /**
     ...
     @param _val represented as java.lang.Integer
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Teacher#FacultyLogicalToDisplay"> Method FacultyLogicalToDisplay</A>
    */
