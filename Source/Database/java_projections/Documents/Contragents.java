...
public class Contragents extends com.intersys.classes.Persistent {
   ...
   */
    ...
    */
    ...
    private static int ii_Document = 5;
    private static int jj_Document = 0;
    private static int kk_Document = 5;
    /**
    ...
    */
    ...
    private static int ii_EndDateOfSigning = 6;
    private static int jj_EndDateOfSigning = 0;
    private static int kk_EndDateOfSigning = 6;
    /**
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Documents.Contragents#PersonGetObject"> Method PersonGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Documents.Contragents#PersonGetObjectId"> Method PersonGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Documents.Contragents#PersonIndexExists"> Method PersonIndexExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Documents.Contragents#PersonSetObject"> Method PersonSetObject</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Documents.Contragents#PersonSetObjectId"> Method PersonSetObjectId</A>
    */
