...
public class Notification extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 7571;
   ...
   */
    ...
    */
    ...
    private static int ii_Period = 6;
    private static int jj_Period = 0;
    private static int kk_Period = 6;
    /**
    ...
    */
    ...
    private static int ii_Text = 3;
    private static int jj_Text = 0;
    private static int kk_Text = 3;
    /**
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Notification#PersonDisplayToLogical"> Method PersonDisplayToLogical</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=TPCS&CLASSNAME=Institute.Notification#PersonLogicalToDisplay"> Method PersonLogicalToDisplay</A>
    */
